...
----
dependencies {
    implementation 'io.github.debugoss:xml2jdto-core:VERSION'
}
----
...
*Solution*: Ensure the XSD file is in your classpath. Place it in link:configuration.html[Configured] directory (example: `src/main/resources/schemas/`).
...
1. Review the link:examples.html[Examples]
2. Search or create an issue on https://github.com/debugOSS/xml2jdto/issues[GitHub]
